...
class YT_UtilsUI:
    ...
    def _reproducirSonido(self, widget_id:str):
        ...
        button = self.mainwindow.children["!notebook"].children["!frame"].children[widget_id]
    ...
    def _resultadoTraduccion(self, txtEditor:tk.Text):
        try:
            resultCode, textoObtenido = traducirImagenPortaPapeles()
            txtEditor.delete("1.0", tk.END)
